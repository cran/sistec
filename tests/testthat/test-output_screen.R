...
test_that("compare_screen works", {
  ...
  expect_true(grepl("Alunos não encontrados:<br/>&emsp; - Sistec: 528<br/>&emsp; - Qacademico: 3773", output_screen))
  ...
  expect_true(grepl("Vínculos não encontrados:<br/>&emsp; - Sistec: 111<br/>&emsp; - Qacademico: 177", output_screen))
